      ...
      <div className="liquid-container relative z-10 w-full max-w-full space-y-3 overflow-hidden sm:space-y-5">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div className="liquid-panel flex size-8 items-center justify-center rounded-xl sm:size-10 sm:rounded-2xl">
              <Gear size={18} weight="fill" className="text-slate-700 sm:hidden" />
              <Gear size={22} weight="fill" className="hidden text-slate-700 sm:block" />
            </div>
        ...
        <GlassCard variant="strong" className="p-4 sm:p-5" glow="none">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-700">Chế độ hiển thị</p>
        ...
        <GlassCard variant="strong" className="p-4 sm:p-5" glow="none">
          ...
          <button
            ...
            className="w-full rounded-xl border border-slate-300/60 bg-white/90 px-4 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-white"
          >
            Quản lý mẫu task
          </button>
        </GlassCard>
        ...
        <GlassCard variant="strong" className="p-4 sm:p-5" glow="none">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1">
              <p className="text-sm font-medium text-slate-700">Nhắc nhở tasks</p>
          ...
          <button
            ...
            className="mt-3 w-full rounded-xl border border-blue-300/60 bg-blue-50 px-4 py-2.5 text-sm font-semibold text-blue-700 transition hover:bg-blue-100"
          >
            🧪 Test thông báo
          </button>
        </GlassCard>
        ...
        <GlassCard variant="strong" className="p-4 sm:p-5" glow="none">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full rounded-xl border border-slate-300/60 bg-white/90 px-4 py-2.5 text-left text-sm font-medium text-slate-700 transition hover:bg-white"
            >
              Xuất file JSON
            </button>
            <button
        ...
        <GlassCard variant="strong" className="p-4 sm:p-5" glow="none">
          ...
          <label className="block w-full cursor-pointer rounded-xl border border-slate-300/60 bg-white/90 px-4 py-2.5 text-center text-sm font-medium text-slate-700 transition hover:bg-white">
        ...
        <GlassCard variant="strong" className="border-red-200 p-4 sm:p-5" glow="none">
          <h3 className="mb-3 flex items-center gap-2 text-sm font-semibold text-red-700 sm:text-base">
            <Trash size={18} weight="bold" />
            Vùng nguy hiểm
          </h3>
          <button
            onClick={handleClearData}
            className="w-full rounded-xl border border-red-300 bg-red-50 px-4 py-2.5 text-sm font-semibold text-red-700 transition hover:bg-red-100"
          >
            Xóa toàn bộ dữ liệu
          </button>
        </GlassCard>

        <GlassCard className="p-4 text-center text-xs text-slate-500" glow="none">
